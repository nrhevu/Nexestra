...
| [0007](0007-master-on-claude-opus-5-messages-api.md) | The Master is Claude Opus 5 over the Messages API | Accepted |
...
| [0012](0012-react-vite-terminal-ui-on-port-5173.md) | React 19 + Vite, terminal-like UI, dev on port 5173 | Accepted (amends PLAN §1.1) |
...
| [0018](0018-fake-harness-for-dev-and-tests.md) | A fake harness adapter, and a `fake` harness id | Accepted (amends PLAN §1.7) |
| [0019](0019-demo-llm-client-without-an-api-key.md) | `DemoLlmClient` when there is no API key | Accepted |
